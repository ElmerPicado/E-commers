...
CREATE TABLE IF NOT EXISTS streaming_config (
  ...
  church_name TEXT NOT NULL DEFAULT 'IMR4',
  church_logo_url TEXT NOT NULL DEFAULT '',
  facebook_url TEXT NOT NULL DEFAULT '',
  instagram_url TEXT NOT NULL DEFAULT '',
  church_address TEXT NOT NULL DEFAULT 'Río Cuarto, Alajuela, Costa Rica',
  church_maps_url TEXT NOT NULL DEFAULT '',
  church_email TEXT NOT NULL DEFAULT '',
  church_description TEXT NOT NULL DEFAULT '',
  youtube_channel_url TEXT NOT NULL DEFAULT '',
  form_bg_url TEXT NOT NULL DEFAULT '',
  history_bg_url TEXT NOT NULL DEFAULT '',
  schedule_text TEXT NOT NULL DEFAULT '',
  connection_text TEXT NOT NULL DEFAULT '',
  welcome_title TEXT NOT NULL DEFAULT 'Bienvenidos a IMR4',
  welcome_text TEXT NOT NULL DEFAULT '',
  welcome_image_url TEXT NOT NULL DEFAULT '',
  welcome_pastors_title TEXT NOT NULL DEFAULT 'Nuestros Pastores',
  welcome_pastors_subtitle TEXT NOT NULL DEFAULT '',
  home_ministries_bg_url TEXT NOT NULL DEFAULT '',
  home_activities_bg_url TEXT NOT NULL DEFAULT '',
  home_news_bg_url TEXT NOT NULL DEFAULT '',
...
INSERT INTO ministries (id, name, description, hero_title, hero_desc, accent_color, icon_name, pillars, schedule, location, contact_email, contact_link, visual_settings) VALUES
('unanimes', 'Unánimes - Jóvenes', 'Nuestra red de jóvenes apasionados. Un espacio dinámico, moderno y lleno de propósito.', 'Un Solo Corazón, Una Sola Visión', 'Somos la juventud de IMR4. Un espacio diseñado especialmente para ti, donde conectamos con Dios.', '#06b6d4', 'Flame', '[{"icon": "Calendar", "title": "¿Cuándo nos reunimos?", "desc": "Sábados desde las 20:30 hs."}, {"icon": "MapPin", "title": "¿Dónde?", "desc": "Salón principal de IMR4."}, {"icon": "Users", "title": "Grupos Pequeños", "desc": "Reuniones semanales en hogares."}]'::jsonb, 'Sábados 20:30 hs', 'Salón Principal', 'jovenes@imr4.org', 'https://wa.me/1', '{"theme_mode": "dark", "layout_style": "modern", "primary_action_text": "Participar", "primary_action_url": "#contacto", "custom_labels": {"pillars": "Pilares"}}'::jsonb),
('mujeres', 'Ministerio de Mujeres', 'Unidas en fe y amor. Encuentros, talleres y edificación espiritual.', 'Mujeres de Fe y Propósito', 'Un espacio dedicado al crecimiento espiritual y apoyo mutuo de las mujeres de IMR4.', '#dc2626', 'Heart', '[{"icon": "Coffee", "title": "Té y Comunión", "desc": "Meriendas especiales y charlas."}, {"icon": "BookOpen", "title": "Estudios Bíblicos", "desc": "Estudios de personajes bíblicos."}, {"icon": "Calendar", "title": "Reunión General", "desc": "Viernes quincenales 18:00 hs."}]'::jsonb, 'Viernes quincenales 18:00 hs', 'Salón de Conferencias', 'mujeres@imr4.org', 'https://wa.me/2', '{"theme_mode": "light", "layout_style": "warm", "primary_action_text": "¿Necesitas oración?", "primary_action_url": "#contacto", "custom_labels": {"pillars": "Grupos de Apoyo"}}'::jsonb),
('hombres', 'Ministerio de Hombres', 'Forjando hombres de valor. Grupos de crecimiento y apoyo mutuo.', 'Hombres de Valor y Carácter', 'Equipando a los varones para liderar con integridad y servir a sus familias.', '#10b981', 'Shield', '[{"icon": "Users", "title": "Desayunos de Fe", "desc": "Un sábado al mes con devocional."}, {"icon": "Briefcase", "title": "Liderazgo", "desc": "Principios bíblicos y desarrollo."}, {"icon": "Calendar", "title": "Reunión de Crecimiento", "desc": "Viernes quincenales 20:00 hs."}]'::jsonb, 'Viernes quincenales 20:00 hs', 'Auditorio Secundario', 'hombres@imr4.org', 'https://wa.me/3', '{"theme_mode": "dark", "layout_style": "modern", "primary_action_text": "Únete a la Tropa", "primary_action_url": "#contacto", "custom_labels": {"pillars": "Principios"}}'::jsonb),
('ninos', 'IMR4 Niños', 'Formando el semillero de fe. Actividades lúdicas y lecciones de valores.', 'Aprendiendo y Creciendo Juntos', 'Un ambiente seguro y divertido para los niños de Río Cuarto.', '#f97316', 'Sun', '[{"icon": "Smile", "title": "Clases por Edades", "desc": "Grupos adaptados de 3 a 11 años."}, {"icon": "Sparkles", "title": "Juegos y Creatividad", "desc": "Manualidades y música interactiva."}, {"icon": "Calendar", "title": "Horarios de Domingo", "desc": "Domingos simultáneos a las 10:00 hs."}]'::jsonb, 'Domingos 10:00 hs', 'Aulas Infantiles', 'ninos@imr4.org', 'https://wa.me/4', '{"theme_mode": "light", "layout_style": "playful", "primary_action_text": "Escuela Dominical", "primary_action_url": "#contacto", "custom_labels": {"pillars": "Clases"}}'::jsonb)
ON CONFLICT (id) DO NOTHING;
