...
const handleEstudianteSubmit = async (e) => {
  ...
  try {
    ...
    // 1. Consultar la vista pública segura para la división
    ...
    // 2. Consultar la tabla de estudiantes activos
    ...
    // 3. Guardar la sesión del estudiante para que el componente AulaVirtual la reconozca
    localStorage.setItem('estudiante_actual', JSON.stringify(estudianteData));

    // 4. Redirigir al Aula Virtual (ajusta la ruta '/aula-virtual' si usas otra distinta en tu router)
    setTimeout(() => {
